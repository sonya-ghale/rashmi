      ...
      <div className="flex flex-col justify-center md:flex-row h-screen">
        ...
        p-8 rounded-tr-[80px] rounded-br-[80px] ">
          <div className="text-center h-[376px]">
            ...
            <p className="text-gray-300 mb-12">Already have an
              account? Sign in now.</p>
            <Link to={"/login"} className="boarder-2 rounded-lg
            font-semibold boarder-white py-2 px-8
        ...
        bg-white p-8">
          <div className="w-full max-w-sm">
            ...
            mb-12">Please provide your information to
            sign up.</p>
            <form onSubmit={handleRegister}>
              ...
              <div className="bloack md:hidden font-semibold
              mt-5">
